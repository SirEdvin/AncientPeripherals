...
import siredvin.site.progressiveperipherals.testmod.TestMod;
...
public class TestHooks {
    ...
    private static int countdown = 20 * 5;
    ...
    public static void onRegisterCommands(RegisterCommandsEvent event) {
        ...
        PPTestCommand.register(event.getDispatcher());
    }
    ...
    public static void onServerStarted(FMLServerStartedEvent event) {
        ...
        PPTestCommand.importFiles(server);
    }

    @SubscribeEvent
    public static void onServerTick(TickEvent.ServerTickEvent event) {
        boolean isTestRun = System.getProperty(String.format("%s.run", TestMod.MOD_ID), "false").equals("true");
