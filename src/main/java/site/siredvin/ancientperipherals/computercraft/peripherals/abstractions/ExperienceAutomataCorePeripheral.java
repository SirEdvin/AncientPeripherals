...
public abstract class ExperienceAutomataCorePeripheral extends AutomataCorePeripheral {
    ...
    protected int getRawCooldown(String s) {
        if (s.equals(TRANSFER_XP_OPERATION))
            return AncientPeripheralsConfig.transferXPCooldown;
        return 0;
    }
    ...
    public Map<String, Object> getPeripheralConfiguration() {
        ...
        data.put("transferXPCost", AncientPeripheralsConfig.transferXPCost);
        data.put("transferXPCooldown", AncientPeripheralsConfig.transferXPCooldown);
        data.put("xpToFuelRate", AncientPeripheralsConfig.xpToFuelRate);
        return data;
    }
    ...
    public final int burnXP(int limit) throws LuaException {
        ...
        addFuel(burnAmount * AncientPeripheralsConfig.xpToFuelRate);
        return burnAmount;
    }
